    ...
    <footer className="bg-slate-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Idah Makena Ncooro</h3>
            <p className="text-slate-300">
              IT Service Desk & Monitoring Specialist with 7+ years of experience in the banking and financial sector.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/experience" className="text-slate-300 hover:text-blue-400 transition-colors">
                  Experience
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-slate-300 hover:text-blue-400 transition-colors">
                  Projects
                </Link>
              </li>
              <li>
              ...
              <li>
                <a 
                  href="https://imakena2.github.io/techace-website/index.html" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-slate-300 hover:text-blue-400 transition-colors"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:imakena@gmail.com" className="hover:text-blue-400 transition-colors">
                  imakena@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                <a href="tel:+254722124963" className="hover:text-blue-400 transition-colors">
                  +254 722 124 963
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-12 pt-6 border-t border-slate-700 text-center text-slate-400">
          <p>&copy; {currentYear} Idah Makena Ncooro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
